...
def _apply_subscription_state(user: User, *, status_value: Optional[str], subscription_id: Optional[str], period_end: Optional[int], customer_id: Optional[str] = None) -> None:
    if customer_id:
